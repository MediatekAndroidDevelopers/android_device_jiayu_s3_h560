...
# Linker
LINKER_FORCED_SHIM_LIBS := /system/lib/liblog.so|libmtkshim_log.so:/system/lib64/liblog.so|libmtkshim_log.so:/system/lib/libui.so|libmtkshim_ui.so:/system/lib64/libui.so|libmtkshim_ui.so:/system/lib/hw/audio.primary.mt6752.so|libmtkshim_audio.so:/system/lib/libMtkOmxVdec.so|libmtkshim_omx.so
